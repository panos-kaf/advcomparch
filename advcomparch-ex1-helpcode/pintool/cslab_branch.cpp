...
VOID InitPredictors()
{
    ...
    //NbitPredictor *nbitPred = new NbitPredictor(15, 1); //commented this
    //branch_predictors.push_back(nbitPred); //commented this

    // Pentium-M predictor
    //PentiumMBranchPredictor *pentiumPredictor = new PentiumMBranchPredictor(); //commented this
    //branch_predictors.push_back(pentiumPredictor); //commented this
}
